...
Kubernetes . This document provides an overview of the different
approaches. Read the [Kubectl book](httpskubectl.docs.kubernetes.io) for
...
See the [API reference](docsreferencegeneratedkubernetes-api)
