...
Kubernetes leverages [X.509 client certificate](docsreferenceaccess-authn-authzauthentication#x509-client-certificates)
...
- Group data is embedded in the `O` value of the client certificate, which means the users group
...
[static token file](docsreferenceaccess-authn-authzauthentication#static-token-file) located
...
[Bootstrap tokens](docsreferenceaccess-authn-authzbootstrap-tokens) are used for joining
...
[Service account secrets](docsreferenceaccess-authn-authzservice-accounts-admin#manual-secret-management-for-serviceaccounts)
...
[OpenID Connect (OIDC)](docsreferenceaccess-authn-authzauthentication#openid-connect-tokens).
...
[authenticating proxy](docsreferenceaccess-authn-authzauthentication#authenticating-proxy).
...
- [User Authentication](docsreferenceaccess-authn-authzauthentication)
- [Authenticating with Bootstrap Tokens](docsreferenceaccess-authn-authzbootstrap-tokens)
- [kubelet Authentication](docsreferenceaccess-authn-authzkubelet-authn-authz#kubelet-authentication)
- [Authenticating with Service Account Tokens](docsreferenceaccess-authn-authzservice-accounts-admin#bound-service-account-tokens)
