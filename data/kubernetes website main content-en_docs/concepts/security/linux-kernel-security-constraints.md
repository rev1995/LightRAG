...
[Configure a SecurityContext for a Pod or Container](docstasksconfigure-pod-containersecurity-context).
...
container image, which is especially useful if youre running images that you
dont own.
...
to one that doesnt have the correct permissions could lead to file access
...
chance that youll need to enforce your configured kernel security capabilities.
...
root user on your nodes host machine. Linux uses *capabilities* to divide the
...
[Restrict a Containers Syscalls with seccomp](docstutorialssecurityseccomp)
or the [Seccomp node reference](docsreferencenodeseccomp)

To learn more about seccomp, see
[Seccomp BPF](httpswww.kernel.orgdochtmllatestuserspace-apiseccomp_filter.html)
...
**Recommendation** Use the default seccomp profile thats bundled with your
...
[AppArmor](httpsapparmor.net) is a Linux kernel security module that
...
containers are allowed to do, andor provide better auditing through system
...
[Restrict a Containers Access to Resources with AppArmor](docstutorialssecurityapparmor).
...
[Assign SELinux labels to a container](docstasksconfigure-pod-containersecurity-context#assign-selinux-labels-to-a-container).
...
[CVE-2019-5736](httpsaccess.redhat.comsecuritycvecve-2019-5736).
...
[`securityContext`](docstasksconfigure-pod-containersecurity-context)
...
including capabilities that they dont require. For example, a root user in a
...
capability that you cant grant with the securityContext. This is useful for
...
* Before configuring kernel-level security capabilities, you should consider
  ...
  [Security Checklist](docsconceptssecuritysecurity-checklist#network-security).
...
[Use a User Namespace With a Pod](docstasksconfigure-pod-containeruser-namespaces).

# #  heading whatsnext

* [Learn how to use AppArmor](docstutorialssecurityapparmor)
* [Learn how to use seccomp](docstutorialssecurityseccomp)
* [Learn how to use SELinux](docstasksconfigure-pod-containersecurity-context#assign-selinux-labels-to-a-container)
