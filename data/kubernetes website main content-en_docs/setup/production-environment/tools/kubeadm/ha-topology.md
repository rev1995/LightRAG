...
[Clustering Guide](httpsgithub.cometcd-ioetcdblobrelease-3.4Documentationop-guideclustering.md#static)
for more details.

# # Stacked etcd topology

A stacked HA cluster is a [topology](httpsen.wikipedia.orgwikiNetwork_topology) where the distributed
...
![Stacked etcd topology](imageskubeadmkubeadm-ha-topology-stacked-etcd.svg)

# # External etcd topology

An HA cluster with external etcd is a [topology](httpsen.wikipedia.orgwikiNetwork_topology)
...
![External etcd topology](imageskubeadmkubeadm-ha-topology-external-etcd.svg)

# #  heading whatsnext

- [Set up a highly available cluster with kubeadm](docssetupproduction-environmenttoolskubeadmhigh-availability)
