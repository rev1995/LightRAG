...
though, if it was a good idea to encrypt some data, its also a good idea to leave them
encrypted.
...
[`EncryptionConfiguration`](docsreferenceconfig-apiapiserver-config.v1).
You can see an example configuration
in [Encryption at rest configuration](docstasksadminister-clusterencrypt-data#understanding-the-encryption-at-rest-configuration).
...
[`hostPath`](docsconceptsstoragevolumes#hostpath) volume mount. Once you locate the volume
