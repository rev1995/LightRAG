...
[Installing kubeadm](docssetupproduction-environmenttoolskubeadminstall-kubeadm), such as,
kubeadm, the kubelet and a .
...
* See how to [add Windows worker nodes](docstasksadminister-clusterkubeadmadding-windows-nodes).
