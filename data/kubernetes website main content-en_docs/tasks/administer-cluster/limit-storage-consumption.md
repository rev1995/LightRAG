...
The following resources are used in the demonstration [ResourceQuota](docsconceptspolicyresource-quotas),
[LimitRange](docstasksadminister-clustermanage-resourcesmemory-default-namespace),
and [PersistentVolumeClaim](docsconceptsstoragepersistent-volumes).
...
clusters storage budget without risk of any one project going over their allotment.
