...
Kubernetes provides a built-in [admission controller](docsreferenceaccess-authn-authzadmission-controllers#podsecurity)
to enforce the [Pod Security Standards](docsconceptssecuritypod-security-standards).
You can configure this admission controller to set cluster-wide defaults and [exemptions](docsconceptssecuritypod-security-admission#exemptions).
...
- name PodSecurity
  configuration
    apiVersion pod-security.admission.config.k8s.iov1 # see compatibility note
