...
Refer to the [kubernetes API reference](docsreferencegeneratedkubernetes-api)
for details.
...
The `create`, `replace`, and `delete` commands work well when each objects
...
a HorizontalPodAutoscaler, makes updates directly to a live object. Heres
an example
